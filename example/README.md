...
EXAMPLE_TCP_TLS_ENABLE=y 时启用 SSL socket（端口默认切 443），需配合 EXAMPLE_TCP_TLS_CA_CERT_PEM 提供 CA，并先用 lwlte_ssl_provision() 配置 SSL context（Air780EP ctx 0、ML307R ssl_id 0）。
